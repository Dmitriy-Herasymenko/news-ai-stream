...
const categories = [
  { value: "business", labelEn: "Business", labelUa: "Бізнес" },
  { value: "entertainment", labelEn: "Entertainment", labelUa: "Розваги" },
  { value: "general", labelEn: "General", labelUa: "Загальні" },
  { value: "health", labelEn: "Health", labelUa: "Здоров'я" },
  { value: "science", labelEn: "Science", labelUa: "Наука" },
  { value: "sports", labelEn: "Sports", labelUa: "Спорт" },
  { value: "technology", labelEn: "Technology", labelUa: "Технології" },
];
...
export default function CategoriesMenu({
  ...
  const currentLabel = country === "en" ? currentCategory?.labelEn : currentCategory?.labelUa;
      ...
      <div className="block sm:hidden mb-6 relative space-y-4">
        ...
        <div className="flex justify-end gap-4 text-sm font-semibold text-gray-700 dark:text-gray-200">
          <span
            ...
            className={`cursor-pointer hover:underline transition ${country === "en" ? "underline text-black dark:text-white" : ""
              }`}
          >
            Eng
          </span>
          <span
            ...
            className={`cursor-pointer hover:underline transition ${country === "ua" ? "underline text-black dark:text-white" : ""
              }`}
          >
            Ukraine
          </span>
        ...
        focus:outline-none focus:border-red-600"
          >
         {categories?.map(({ labelEn, labelUa, value }) => (
  <option key={value} value={value}>
    {country === "en" ? labelEn : labelUa}
  </option>
))}
          </select>
