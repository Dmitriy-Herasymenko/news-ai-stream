export async function generateCommentsCohereChat(articleTitle?: string, articleSummary?: string, language?: string) {
  const prompt = `
  Створи кожен раз рандомну кількість від 3 до 25 коротких коментарів до новини з заголовком "${articleTitle}" і описом "${articleSummary}".
  Коментарі повинні бути на ${language || "eng"} мові та виглядати як справжні — різні стилі, різні точки зору. Виведи список у форматі:

  1. Ім'я славянське чи европейське: Коментар
  2. ...
  `;
